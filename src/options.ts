...
export interface PcrDefaultOptions {
   ...
   */
  detectionPath: string | string[]; // Changed to allow string array directly for clarity
   ...
   */
  cacheRevisions: number; // Its actual usage might need verification in the codebase
...
const defaultOptions: PcrDefaultOptions = {
  revision: '',
